...
## تحديث صلاحيات بنك الأسئلة لجميع الألعاب — 14 يوليو 2026

- أصبحت صفحة `dashboard/admin` تعرض جميع الألعاب الـ12 داخل «صلاحيات بنك الأسئلة للألعاب» بدلاً من 6 ألعاب فقط.
- القائمة موحدة الآن مع `GAME_MODES` حتى لا تُنسى أي لعبة جديدة مستقبلاً.
- الألعاب التي تستخدم البنك العام تعرض تحكم التصنيفات وأنواع الأسئلة: تحدي الأسئلة، الزنزانة، حرب الفرق، الكلمة المفقودة، كشف الستار، تركيبة، وفلوسك على المحك.
- الألعاب ذات البنك المتخصص تعرض مصدرها بشكل واضح: بعثرة وTOP 10.
- الألعاب التي لا تحتاج بنكاً في آليتها الحالية تظهر للمدير مع توضيح السبب: الكراسي، أمبوستر، والروليت.
- أضيف الحقل `bankEnabled` إلى صلاحيات اللعبة للسماح بالبنك أو منعه بالكامل.
- تعطيل البنك العام يمنع ظهور أسئلته في المعالج وفي تعديلات الجلسة.
- تعطيل بنك TOP 10 يمنع الاختيار العشوائي والمحدد ويبقي السؤال المخصص متاحاً.
- تعطيل بنك بعثرة يخفي الجولات الجاهزة ويبقي الإدخال اليدوي متاحاً.
- تم تحديث API الإدارة لحفظ `bankEnabled` مع التصنيفات وأنواع الأسئلة.
- نجح البناء المحلي وبناء Vercel، ونُشرت النسخة على `https://mosabqah.vercel.app`.
